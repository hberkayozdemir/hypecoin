...
class ManageEditorScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ManageEditorScreenState();
  }
}

class _ManageEditorScreenState extends State<ManageEditorScreen> {
